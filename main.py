...
hidden_layer_size = 50 # TODO 2 dla normalizacji [0, 1] i sigmoidalnej w ostatniej warstwie, 16 dla [-1,1], bez sigmo i z inną funkcją straty
output_layer_size = 1
...
def test(filename, coef, alpha):
    ...
    loss, score, predicted, actual = algorithm_validation(test_data, perceptron)
